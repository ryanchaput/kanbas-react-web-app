                ...
                <div className={activeTab === "section1" ? "tab-pane active" : "tab-pane"} id="section1">
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item">
                            ...
                            <input type="text" id="name" value={quiz.name} />
                        </li>
                        <li className="list-group-item">
                            <label htmlFor="description">Description</label>
                            <textarea id="description" value={quiz.description} />
                        </li>
                        <li className="list-group-item">
                        <label htmlFor="type">Quiz Type</label>
                            <select id="type" value={quiz.type}>
                        ...
                        <li className="list-group-item">
                            ...
                            <input type="number" id="points" value={quiz.points} />
                        </li>
                        <li className="list-group-item">
                            <label htmlFor="shuffle">Shuffle Answers</label>
                            <select id="shuffle" value={quiz.shuffle}>
                        ...
                        <li className="list-group-item">
                            ...
                            <input type="number" id="time" value={quiz.time} />
                        </li>
                        <li className="list-group-item">
                            <label htmlFor="multipleAttempts">Multiple Attempts</label>
                            <select id="multipleAttempts" value={quiz.multipleAttempts}>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </li>
                        <li className="list-group-item">
                            ...
                            <select id="showCorrect" value={quiz.showCorrect}>
                        ...
                        <li className="list-group-item">
                            ...
                            <select id="oneQ" value={quiz.oneQ}>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </li>
                        <li className="list-group-item">
                            ...
                            <select id="camera" value={quiz.camera}>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </li>
                        <li className="list-group-item">
                            ...
                            <select id="lockQ" value={quiz.lockQ}>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </li>
                        ...
                        <label htmlFor="published">Published</label>
                            <select id="published" value={quiz.published}>
                        ...
                        <li className="list-group-item">
                            ...
                            <input type="date" id="due" value={quiz.due} />
                        </li>
                        <li className="list-group-item">
                            <label htmlFor="available">Available Date</label>
                            <input type="date" id="available" value={quiz.available} />
                        </li>
                        <li className="list-group-item">
                            <label htmlFor="until">Until Date</label>
                            <input type="date" id="until" value={quiz.until} />
                        </li>
                    </ul>
                </div>
